...
namespace robotic_vision {
  ...
  public:
    ...
    virtual void find_correspoinding_features(const cv::Mat& img, std::vector<cv::Point2f>& prev_matched, std::vector<cv::Point2f>& matched_features, const cv::Mat& mask) = 0;
