...
TTRRansac::TTRRansac() {
	...
	cv::resizeWindow("Tracks", 600, 400);
...
void TTRRansac::set_parameters() {
	...
	params_.M =  30;
	params_.tauR = 50.0;
	params_.set_motion_model(static_cast<enum rransac::core::MotionModelType>(0));
	...
	params_.gamma = 0.5;
	params_.set_motion_model_RANSAC(static_cast<enum rransac::core::MotionModelType>(0));
